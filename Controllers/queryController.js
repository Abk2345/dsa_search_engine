...
//controllers for search for
// post_from_mainpage, post_from_homepage

const post_from_mainpage = (req, res) => {
    ...
    (async function () {
        ...
        // console.log(doc);
        res.render('homepage_15_problems', { body: doc });

    })();
}

const post_from_homepage = (req, res) => {
    console.log(req.body.name);
    var query = req.body.name;
    var string = query.toLowerCase();
