...
//now start
var number_keyword_doc = [];
var all_keywords = new Set();
for(var i=0; i<x; i++)
{
    var string = problem_desc[i];
    string = string.replace(/(\r\n|\n|\r)/gm, ' ');
    // console.log(string);
  ...
  var regex = /[.,\s]/g;
   ...
   string = string.replace(regex, ' ');
    ...
    // console.log(string);
    var array = removeStopwords(string);
    number_keyword_doc.push(array.length);
    array.forEach(element => {
        // console.log(element.trim());
        if(element.trim())
        {
           all_keywords.add(element.trim());
        }
    })
}
...
//             }
//             // tf_row_values.push(i);
//             // tf_row_values.push(cnt);
...
//             tf_row_values.push(i);
//             tf_row_values.push(cnt);
//             var t = doc_map.get(element)/doc_map.size;
//             tf_row_values.push(t*itfValue[cnt-1]);
//         }
//     });
//     tf_values.push(tf_row_values);
...
// fs.writeFile('itf_value_desc.txt', content, err => {
//   if (err) {
//     console.error(err)
//     return
//   }else{
...
// // fs.writeFile('tf_value_doc_desc.txt', content, err => {
// //     if (err) {
// //       console.error(err)
// //       return
// //     }else{
...
// console.log(content);
fs.writeFile('all_keywords_desc.txt', content, err => {
    if (err) {
      console.error(err)
      return
    }else{
...
// // var content = number_keyword_doc.toString();
// // fs.writeFile('number_keyword_doc.txt', content, err => {
// //     if (err) {
// //       console.error(err)
// //       return
// //     }else{
...
// // console.log(number_keyword_doc.length);
